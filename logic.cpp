...
vector<EjercicioAritmetica*> obtenerEjerciciosFacilAritmetica() {
    ...
    ejercicios.push_back(new EjercicioAritmetica("√16", "4", "facil", "aritmetica", 1));
    ...
    ejercicios.push_back(new EjercicioAritmetica("√9 + 1", "4", "facil", "aritmetica", 1));
...
vector<EjercicioAritmetica*> obtenerEjerciciosIntermedioAritmetica() {
    vector<EjercicioAritmetica*> ejercicios;
    ejercicios.push_back(new EjercicioAritmetica("√49 + 2", "9", "intermedio", "aritmetica", 2));
    ...
    ejercicios.push_back(new EjercicioAritmetica("√81 - 3", "6", "intermedio", "aritmetica", 2));
    ...
    ejercicios.push_back(new EjercicioAritmetica("√64 + √36", "14", "intermedio", "aritmetica", 2));
...
vector<EjercicioAritmetica*> obtenerEjerciciosDificilAritmetica() {
    vector<EjercicioAritmetica*> ejercicios;
    ejercicios.push_back(new EjercicioAritmetica("√121 + 5^2", "36", "dificil", "aritmetica", 3));
    ejercicios.push_back(new EjercicioAritmetica("√100 + 3^3", "37", "dificil", "aritmetica", 3));
    ejercicios.push_back(new EjercicioAritmetica("4^3 - √81", "55", "dificil", "aritmetica", 3));
    ...
    ejercicios.push_back(new EjercicioAritmetica("√144 + √49", "17", "dificil", "aritmetica", 3));
    ejercicios.push_back(new EjercicioAritmetica("5^3 / 5", "25", "dificil", "aritmetica", 3));
    ejercicios.push_back(new EjercicioAritmetica("√169 + 2^4", "33", "dificil", "aritmetica", 3));
