...
void obtenerEjercicioAritmeticaFacil () {
    ...
    for (int i = 0; i < ejercicios.size(); i++) {
        ...
        if (respuestaUsuario == ejercicios[i]->getRespuesta()) {
            cout << "Respuesta correcta!" << endl;
        } else {
            cout << "Respuesta incorrecta. La respuesta correcta es: " << ejercicios[i]->getRespuesta() << endl;
        }
    }
}
...
void obtenerTodosLosEjercicios() {
    ...
    for (int i = 0; i < ejerciciosAritmeticaFacil.size(); i++) {
        ...
        cin >> respuestaUsuario;
        if (respuestaUsuario == ejerciciosAritmeticaFacil[i]->getRespuesta()) {
            cout << "Respuesta correcta!" << endl;
        } else {
            cout << "Respuesta incorrecta. La respuesta correcta es: " << ejerciciosAritmeticaFacil[i]->getRespuesta() << endl;
        }
    }
    ...
    for (int i = 0; i < ejerciciosAritmeticaIntermedio.size(); i++) {
        ...
        cin >> respuestaUsuario;
        if (respuestaUsuario == ejerciciosAritmeticaIntermedio[i]->getRespuesta()) {
            cout << "Respuesta correcta!" << endl;
        } else {
            cout << "Respuesta incorrecta. La respuesta correcta es: " << ejerciciosAritmeticaIntermedio[i]->getRespuesta() << endl;
        }
    }
    ...
    for (int i = 0; i < ejerciciosAritmeticaDificil.size(); i++) {
        ...
        cout << "Dificultad: " << ejerciciosAritmeticaDificil[i]->getDificultad() << endl;

        cin >> respuestaUsuario;
        if (respuestaUsuario == ejerciciosAritmeticaDificil[i]->getRespuesta()) {
            cout << "Respuesta correcta!" << endl;
        } else {
            cout << "Respuesta incorrecta. La respuesta correcta es: " << ejerciciosAritmeticaDificil[i]->getRespuesta() << endl;
        }
    }
}
void menu(){
                        ...
                        case 1: {
                            ...
                            if (tipoEjercicio == 1) {
                                ...
                                if (dificultad == 1) {
                                    ...
                                    if (respuestaUsuario == ejercicios[i]->getRespuesta()) {
                                        cout << "Bien Hecho, SIGUIENTE EJERCICIO" << endl;
                                    }
                                    else {
                                        cout << "Incorrecto, la respuesta correcta es: " << ejercicios[i]->getRespuesta() << endl;
                                    }
                                    c
